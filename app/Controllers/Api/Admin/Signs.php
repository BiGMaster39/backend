...
class Signs extends PrivateController
{
     ...
     * @return mixed
     */
    public function short_list_android(int $userId = 0)
    {
     ...
     * @return mixed
     */
    public function short_list_ios(int $userId = 0)
    {
     ...
     * @return mixed
     */
    public function list_android(int $userId = 0)
    {
        $signs = $this->android_signs
            ->where("user_id", $userId)
     ...
     */
    public function create_keystore(int $userId = 0)
    {
     ...
     * @throws ReflectionException
     */
    public function upload_keystore(int $userId = 0)
    {
        helper('filesystem');
        $encrypter = Services::encrypter();
     ...
     * @return mixed
     */
    public function list_ios(int $userId = 0)
    {
        $signs = $this->ios_signs
            ->where("user_id", $userId)
     ...
     * @throws ReflectionException
     */
    public function upload_cert(int $userId = 0)
    {
        helper('filesystem');
